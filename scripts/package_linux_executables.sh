...
DEB_FILE=./out/make/deb/x64/pointnetwork-dashboard-uninstaller_"$VERSION"_amd64.deb
RPM_FILE=./out/make/rpm/x64/pointnetwork-dashboard-uninstaller-"$VERSION"-1.x86_64.rpm
